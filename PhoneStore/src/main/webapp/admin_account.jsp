    ...
    <div class="app-content">
        ...
        <div class="products-area-wrapper tableView">
            ...
            <div class="products-row">
                ...
                <div class="product-cell name"><span class="cell-label">Name:</span>Alenk</div>
                <div class="product-cell email"><span class="cell-label">Email:</span>thanhloi@gmail.com</div>
                <div class="product-cell address"><span class="cell-label">Address:</span>TP HCM</div>
                <div class="product-cell phone"><span class="cell-label">Phone:</span>0854664482</div>
                <div class="product-cell reset"><span class="cell-label">Reset password:</span><button class="sort-button">
