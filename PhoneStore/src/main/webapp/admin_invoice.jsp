            ...
            <div class="card">
                <div class="panel panel-default panel-signing">
                    ...
                    <div class="panel-footer">
                        <div class="text-uppercase"><a href="AdminInvoice?ManageInvoices=sent&amp;invoiceID=<c:out value="${item.invoiceID}" data-toggle="modal"><span class="glyphicon glyphicon-edit" title="Edit Signing"></span> send confirm</a></div>
                    </div>
                </div>
            </div>
            </c:forEach>
