...
<html>
    <div class="app-content">
        <div class="app-content-header">
            <h1 class="app-content-headerText">Discount</h1>
        ...
        <div class="products-area-wrapper tableView">
            ...
            <div class="products-row">
                ...
                <div class="product-cell sales"><span class="cell-label">Discount:</span>30%</div>
                <div class="product-cell stock"><span class="cell-label">Start Date:</span>20/11</div>
                <div class="product-cell price"><span class="cell-label">End Date:</span>21/11</div>
            ...
            <div class="products-row">
                ...
                <div class="product-cell sales"><span class="cell-label">Discount:</span>10%</div>
                <div class="product-cell stock"><span class="cell-label">Start Date:</span>10/11</div>
                <div class="product-cell price"><span class="cell-label">End Date:</span>12/11</div>
                <div class="product-cell update"><span class="cell-label">Update:</span><button class="sort-button">
                        <i class="fa-solid fa-pen-to-square"></i> 
                    </button></div>
                <div class="product-cell remove"><span class="cell-label">Remove:</span><button class="sort-button">
